...
test('works', () => {
  expect(solution(`abcde fghij`)).toBe(1)
  expect(solution(`abcde xyz ecdab`)).toBe(0)
  expect(solution(`a ab abc abd abf abj`)).toBe(1)
  expect(solution(`iiii oiii ooii oooi oooo`)).toBe(1)
  expect(solution(`oiii ioii iioi iiio`)).toBe(0)
  expect(
    solution(`abcde fghij
abcde xyz ecdab
...
test('solution', () => {
  expect(
    solution(`vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
